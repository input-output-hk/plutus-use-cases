...
##  Developing this Plutus Obelisk Dapp
  ...
  1. Diving into PAB and Smart Contract programming!
    This application leverages a significant amount of Lar's Uniswap Smart Contract implementation thoroughly explained in the Plutus Pioneer Program. Here is a video link in case you missed it! https://www.youtube.com/watch?v=Dg36h9YPMz4
  ...
  1. Building and Running PAB in GHCI Repl
    ...
    1. `nix-shell`
    1. `cabal new-repl exe:plutus-starter-pab`, at this point you can use `:r ` to reload and see what the GHC compiler has to say about the changes you've made.
    1. When you're comfortable with your changes, run `main` to start PAB which will cause it to listen on port 8080
