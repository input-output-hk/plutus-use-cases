...
1. Make sure you don't have anything running using port 8080.

2. [Run PAB] After installing Obelisk, use `./scripts/run-pab.sh` to launch the PAB and have it listen on port 8080.
...
##  Supported Browsers
  ...
  Production deploys where the frontend is compiled to JavaScript, rather than puppetteered from the backend for a quick dev debug cycle, do work in firefox.
