...
let
  project = haskell-nix.project {
    ...
    sha256map = {
      "https://github.com/input-output-hk/plutus.git"."plutus-pab/v0.0.2" = "0aicyg6skqhpfciakwn68b9ppkpm95j1x3d4sj3xmc542sr6932g";
      ...
      # "https://github.com/sordina/servant-options"."aa9338b1925e7bc5d65bad35f02aec8c20f8365b" = "0vlp3y414f2i4nhmlp1gh9jns8jydbq1mgv8j7vzh62r506slb1j";
