...
import PAB.Types (taggedJsonEncoding)
...
instance encodeJsonMap :: (EncodeJson a, EncodeJson b) => EncodeJson (Map a b) where
  encodeJson value = genericEncodeJsonWith taggedJsonEncoding value

instance decodeMap :: (DecodeJson a, DecodeJson b) => DecodeJson (Map a b) where
