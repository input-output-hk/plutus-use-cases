...
in rec {
  ...
  inherit (project.mlabs-plutus-use-cases.components.exes)
    lendex-demo nft-demo mlabs-plutus-use-cases;
  inherit (project.mlabs-plutus-use-cases.components.tests)
    mlabs-plutus-use-cases-tests;
